...
public class BoardManager : MonoBehaviour {
	...
	public List<Sprite> EvilCharacters = new List<Sprite>();
	...
	void Start () {
		...
		AllCharacters.AddRange(EvilCharacters);
	...
	private void CreateBoard (float xOffset, float yOffset) {
		...
		for (int x = 0; x < xSize; x++) {
			for (int y = 0; y < ySize; y++) {
				...
				possibleCharacters.AddRange(AllCharacters); // 2
	...
	private Sprite GetNewSprite(int x, int y)
	{
		...
		possibleCharacters.AddRange(AllCharacters);
